...
const ERROR_CODES = {
  ...
  PREFERRED_CURRENCY_PURCHASE_PRICE_RESOLUTION_FAILED: 'PREFERRED_CURRENCY_PURCHASE_PRICE_RESOLUTION_FAILED',
...
const CODE_TO_STATUS: Record<ErrorCode, StatusCode> = {
  ...
  PREFERRED_CURRENCY_PURCHASE_PRICE_RESOLUTION_FAILED: STATUS_CODES.INTERNAL_SERVER_ERROR,
...
const CODE_TO_MESSAGE: Record<ErrorCode, string> = {
  ...
  PREFERRED_CURRENCY_PURCHASE_PRICE_RESOLUTION_FAILED: 'Failed to resolve preferred currency purchase price',
...
export class PreferredCurrencyPurchasePriceResolutionFailed extends PortfolioException {
  constructor(c: HonoContext) {
    super(c, { code: ERROR_CODES.PREFERRED_CURRENCY_PURCHASE_PRICE_RESOLUTION_FAILED });
  }
}
