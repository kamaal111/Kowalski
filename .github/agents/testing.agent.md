...
```
/Users/kamaal/Projects/Swift/Apps/Kowalski/.agents/skills/testing-best-practices/SKILL.md
```

Also read the Swift-specific conventions when working on Swift packages or the app:

```
/Users/kamaal/Projects/Swift/Apps/Kowalski/.agents/skills/testing-best-practices/SWIFT.md
```
